    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview @yield('Profile_active')">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{ route('your.profile') }}"><i class="ti-more"></i>Your Profile</a></li>
                    <li><a href="{{ route('password.view') }}"><i class="ti-more"></i>Change Password</a></li>
                </ul>
            </li>
            <li class="treeview @yield('Setup_active')">
                <a href="#">
                    <i data-feather="lock"></i> <span>Setup Management</span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-right pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu">
                    ...
                    <li><a href="{{ route('fee.amount.view') }}"><i class="ti-more"></i>Fee Category Amount</a>
                    </li>
