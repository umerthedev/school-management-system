...
class StudentRegController extends Controller
{
	...
	//student.class.year.wise search 
	...
	public function StudentRegEdit($student_id){
		...
		return view('backend.student.student_reg.edit-student', $data); 
	...
	//StudentRegPromotionStore
	public function StudentRegPromotionStore(Request $request,$student_id){
    	DB::transaction(function() use($request,$student_id){
